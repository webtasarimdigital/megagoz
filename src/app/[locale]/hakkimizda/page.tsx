                ...
                <div className="prose prose-lg max-w-none text-gray-600 font-medium leading-relaxed space-y-6">
                  {locale === 'en' ? (
                    <>
                      ...
                      <p>We provide services in a wide medical and surgical spectrum ranging from cataract surgery to smart lens (trifocal) implantations, excimer laser (iLasik) treatments to advanced strabismus and glaucoma operations. Eye surgery requires great delicacy, flawless planning, and state-of-the-art equipment. With this awareness, we constantly revise our operating rooms and diagnostic units with the most up-to-date devices in American FDA and European standards in every period.</p>
