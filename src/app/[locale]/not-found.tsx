...
export default function NotFoundPage() {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center bg-[#F8FAFC] py-20 px-4 mt-[100px]">
      <div className="max-w-2xl mx-auto text-center flex flex-col items-center">
        
        {/* Creative 404 Graphic */}
        <div className="relative mb-8 flex justify-center tracking-tighter">
        ...
        <div className="mt-8 mb-10 space-y-4">
          <h1 className="text-3xl md:text-4xl font-black text-[#162f5d] tracking-tight">
            Görünen O Ki, Yanlış Yere Geldiniz
          </h1>
          <p className="text-gray-500 font-medium text-lg leading-relaxed max-w-lg mx-auto">
            ...
            Sağlıklı ve net bir görüşe kavuşmak için ana sayfamıza dönebilirsiniz.
          </p>
        </div>
