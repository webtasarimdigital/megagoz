...
export default function PartnerInstitutionsPage() {
  const partners = [
    ...
    { name: "DEMİR SAĞLIK HAYAT SİGORTA", image: "/images/demir-saglik-hayat-sigorta.webp" },
    { name: "DOĞA SİGORTA A.Ş.", image: "/images/doga_logo_svg.svg" },
    { name: "EKİNOKS GRUP", image: "/images/ekinoks_grup.webp" },
    { name: "ETHICA SİGORTA A.Ş.", image: "/images/ethicasigorta.svg" },
    { name: "KATILIM EMEKLİLİK", image: "/images/katılım-emeklilik.webp" },
    ...
    { name: "PTT", image: "/images/PTT.webp" },
    ...
    { name: "TUR MEDİKAL GRUP", image: "/images/Tur-Medikal-Grup.webp" },
    { name: "TZHEMSAN (TÜRKİYE ZİRAAT HALK BANKASI VAKFI)", image: "/images/Turkiye-Ziraat-Halk-Bankası-vakfi.webp" },
