...
export default function AppointmentFormSection() {
  return (
    <section className="bg-[#384859] py-20 lg:py-28 text-white relative flex justify-center w-full">
       <div className="container px-6 max-w-[1200px] grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
             ...
             <h2 className="text-4xl lg:text-[54px] font-black leading-[1.1] mb-6 tracking-tight">
               HEMEN ÜCRETSİZ<br />
               <span className="font-light">RANDEVU AL</span>
             </h2>

             <p className="text-gray-300 text-[15px] leading-relaxed mb-8 max-w-md font-light">
             ...
             <div className="flex items-center gap-3 bg-white/5 border border-white/10 rounded-xl px-5 py-4 text-sm text-gray-200 font-bold tracking-wide">
                <ShieldCheck className="text-white/60" size={22} strokeWidth={1.5} />
