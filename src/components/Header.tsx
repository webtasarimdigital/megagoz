...
export default function Header() {
  ...
  return (
    <header className="w-full fixed top-0 left-0 right-0 z-50 flex flex-col font-sans">
      ...
      <div 
        className={`bg-[#2c88ac] text-white text-[13px] font-bold transition-all duration-300 origin-top ${
          isScrolled ? "h-0 opacity-0 overflow-hidden" : "h-[45px] opacity-100 flex"
        }`}
      >
        <div className="container mx-auto px-4 max-w-[90rem] flex items-center justify-center h-full">
          <div className="flex items-center w-full justify-between lg:justify-end xl:justify-center">
            {/* Left quick links */}
            <div className="hidden lg:flex items-center">
              <a href="#" className="hover:text-gray-200 transition-colors">Kurumsal</a>
              <span className="px-4 text-white font-normal">|</span>
              ...
              <span className="px-4 text-white font-normal">|</span>
              <a href="#" className="hover:text-gray-200 transition-colors">En Yakın Merkezi Bul</a>
            </div>

            {/* Gap to push right items slightly on huge screens */}
            <div className="hidden xl:block w-16"></div>

            {/* Right contact & settings */}
            <div className="flex items-center shrink-0">
              <a href="tel:4440000" className="text-[14px] hover:text-gray-200 ml-4 lg:ml-0">
                444 0 000
              </a>
              <span className="px-3 text-white font-normal">|</span>
              {/* Social Icons mini */}
              <div className="flex items-center gap-3">
                <a href="#" className="hover:text-gray-200"><svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M12.031 6.172c-3.181 0-5.767 2.586-5.768 5.766-.001 1.298.38 2.27 1.019 3.287l-.582 2.128 2.182-.573c.978.58 1.911.928 3.145.929 3.178 0 5.767-2.587 5.768-5.766.001-3.187-2.575-5.77-5.764-5.771zm3.392 8.244c-.161.453-.835.83-1.173.861-.208.019-.475.05-.912-.096-.334-.112-.801-.274-1.503-.551-1.498-.59-2.454-2.115-2.528-2.214-.074-.099-.603-.803-.603-1.53 0-.727.378-1.085.511-1.229.133-.144.29-.181.386-.181h.286c.096 0 .227-.036.353.272.13.315.438 1.071.478 1.151.04.08.067.172.019.268-.046.096-.073.155-.169.266-.096.111-.2.243-.284.341-.096.114-.199.237-.087.432.112.195.5 .83 1.077 1.347.747.671 1.373.882 1.57.978.196.096.311.08.426-.051.115-.131.491-.568.622-.763.131-.196.262-.163.438-.096.176.067 1.119.529 1.311.625.191.096.318.144.365.224.047.08.047.464-.114.917z"/></svg></a>
                <a href="#" className="hover:text-gray-200"><svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"/></svg></a>
                <a href="#" className="hover:text-gray-200"><svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zM12 0C8.741 0 8.333.014 7.053.072 2.695.272.273 2.69.073 7.052.014 8.333 0 8.741 0 12c0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98C8.333 23.986 8.741 24 12 24c3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98C15.668.014 15.259 0 12 0zm0 5.838a6.162 6.162 0 100 12.324 6.162 6.162 0 000-12.324zM12 16a4 4 0 110-8 4 4 0 010 8zm6.406-11.845a1.44 1.44 0 100 2.881 1.44 1.44 0 000-2.881z"/></svg></a>
              </div>
              <span className="px-3 text-white font-normal">|</span>
              {/* Language Selector */}
              <button onClick={switchLocale} className="flex items-center gap-1 hover:text-gray-200 mr-4 lg:mr-0 text-sm">
      ...
      <div className={`bg-white transition-all duration-300 ${isScrolled ? "shadow-md py-4" : "py-6 border-b-2 border-gray-100"}`}>
        <div className="container mx-auto px-4 max-w-[90rem] flex items-center justify-between xl:justify-center">
          
          <div className="flex items-center w-full justify-between xl:justify-evenly">
            {/* Logo VeniVidi look-alike */}
            <Link href="/" className="flex items-center shrink-0 xl:mr-10">
              <span className="text-[32px] md:text-[38px] font-black tracking-tighter text-[#1f6388]">
              ...
              {navLinks.map((link) => (
                link.href.startsWith("/#") ? (
                  <a 
                    key={link.name} 
                    href={link.href}
                    className="text-[14px] font-bold text-[#454d52] hover:text-[#2c88ac] transition-colors whitespace-nowrap"
                  >
                    {link.name}
                  </a>
                ) : (
            ...
            <div className="hidden xl:flex items-center relative group">
              <input 
                type="text" 
                placeholder="Arama"
                className="border-b-[3px] border-[#2c88ac] py-1 pl-1 pr-6 focus:outline-none text-[15px] font-medium w-40 transition-all focus:w-48 text-[#2c88ac] bg-transparent placeholder:text-[#2c88ac] ml-8" 
              />
            ...
            {/* Mobile Menu Toggle */}
            <button 
              className="xl:hidden text-[#1f6388] ml-auto"
