        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm px-0 list-none">
              ...
              <li><Link href="/#hizmetler" className="hover:text-cyan-vibrant transition-colors">{t("services")}</Link></li>
              <li><Link href="/#blog" className="hover:text-cyan-vibrant transition-colors">{t("blog")}</Link></li>
