...
const SERVICES = [
  ...
  { id: 4, slug: "kornea-hastaliklari", title: "Kornea Hastalıkları", titleEn: "Corneal Diseases", image: "/images/megagoz-kornea-tedavisi.jpg", desc: "Korneanın yapısını bozan keratokonus ve benzeri hastalıkların tanı ve tedavisi.", descEn: "Diagnosis and treatment of keratoconus and similar diseases that disrupt the corneal structure." },
  ...
  { id: 7, slug: "uveit", title: "Üveit Tedavisi", titleEn: "Uveitis Treatment", image: "/images/megagoz-uveit-tedavisi.jpg", desc: "Gözün içindeki damar tabakasının iltihaplanmasının ileri tetkiklerle tedavisi.", descEn: "Treatment of inflammation in the vascular layer of the eye with advanced diagnostics." },
  { id: 8, slug: "goz-kapagi-estetigi", title: "Göz Kapağı Estetiği", titleEn: "Eyelid Aesthetics", image: "/images/megagoz-goz-kapagi-tedavisi.jpg", desc: "Düşük veya torbalanmış göz kapaklarının blefaroplasti ile estetik düzeltilmesi.", descEn: "Aesthetic correction of drooping or bagged eyelids with blepharoplasty." },
