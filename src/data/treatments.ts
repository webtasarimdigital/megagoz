...
export const TREATMENTS_DATA: TreatmentCategory[] = [
  {
    ...
    items: [
      ...
      { 
        slug: "fako-yontemiyle-katarakt-tedavisi", 
      ...
      { slug: "uc-odakli-torik-lensler", title: { tr: "Üç Odaklı Torik Lensler", en: "Trifocal Toric Lenses" }, excerpt: { tr: "Astigmatizmayı düzelten üç odaklı mercek çeşitleri.", en: "Trifocal lenses specifically designed to correct astigmatism." }, image: "/images/megagoz-katarakt.webp" },
      { slug: "tek-odakli-lensler", title: { tr: "Tek Odaklı Lensler (Monofokal)", en: "Monofocal Lenses" }, excerpt: { tr: "Seçilen tek bir odak noktasında kusursuz görüş imkanı.", en: "Perfect vision targeted at a single chosen focal point." }, image: "/images/megagoz-katarakt-tedavisi.webp" },
  ...
  },
  {
    ...
    items: [
      ...
      { slug: "lasek-prk-no-touch-lazer", title: { tr: "LASEK / PRK / No Touch Lazer", en: "LASEK / PRK / No Touch Laser" }, excerpt: { tr: "Göze dokunulmadan sadece ışınla uygulanan lazer tedavisi.", en: "Laser treatment applied without touching the eye." }, image: "/images/megagoz-tedavi-oncesi.webp" },
      ...
      { slug: "yag-lazer-tedavisi", title: { tr: "Yag Lazer Tedavisi", en: "YAG Laser Treatment" }, excerpt: { tr: "İkincil katarakt ve glokom gibi hastalıkların tedavisinde YAG lazer.", en: "YAG laser used for treating secondary cataracts and glaucoma." }, image: "/images/slide1.png" },
      { slug: "goz-tansiyonunda-lazer-tedavisi-slt", title: { tr: "Göz Tansiyonunda Lazer Tedavisi – SLT", en: "SLT Laser Treatment for Glaucoma" }, excerpt: { tr: "Göz içi basıncını düşüren güvenilir lazer operasyonu.", en: "Reliable laser surgery that effectively lowers intraocular pressure." }, image: "/images/megagoz-glukom-tedavisi.webp" }
    ]
  },
  {
    id: "kontak-lens",
    ...
    items: [
      ...
      { slug: "fakik-goz-ici-lens-tedavisi", title: { tr: "Fakik Göz İçi Lens Tedavisi", en: "Phakic Intraocular Lens Treatment" }, excerpt: { tr: "Yüksek miyop ve hipermetrop hastaları için göz içi kalıcı lens tedavisi.", en: "Permanent intraocular lens treatment for high myopia and hyperopia patients." }, image: "/images/megagoz-katarakt.webp" },
      { slug: "add-on-akilli-lens-tedavisi", title: { tr: "Add On Akıllı Lens Tedavisi", en: "Add-On Smart Lens Treatment" }, excerpt: { tr: "Daha önce ameliyat olmuş gözler için ek, yeni nesil mercek ilaveleri.", en: "Supplementary new generation lens additions for previously operated eyes." }, image: "/images/megagoz-lazer-tedavisi,.webp" },
      { slug: "icl-goz-ici-lens-tedavisi", title: { tr: "ICL Göz İçi Lens Tedavisi", en: "ICL Intraocular Lenses" }, excerpt: { tr: "Kornea yapısı lazere uygun olmayanlar için devrimsel mercek.", en: "Revolutionary lens implants for corneas unsuitable for laser." }, image: "/images/slide3.png" }
    ]
  },
  {
    id: "goz-norolojisi",
  ...
  },
  {
    ...
    items: [
      ...
      { slug: "keratokonus", title: { tr: "Keratokonus", en: "Keratoconus" }, excerpt: { tr: "Korneanın incelerek sivrileşmesi ve güncel tanı-tedavi yolları.", en: "Thinning and bulging of the cornea, and current diagnostic-treatment pathways." }, image: "/images/megagoz-kornea-tedavisi.jpg" },
      ...
      { slug: "keratit", title: { tr: "Keratit", en: "Keratitis" }, excerpt: { tr: "Kornea iltihabına neden olan mikroorganizmalar ve iyileşme süreleri.", en: "Microorganisms causing corneal inflammation and recovery periods." }, image: "/images/megagoz-glukom-tedavisi.webp" },
  ...
  },
  {
    ...
    items: [
      ...
      { slug: "goz-kapagi-ameliyati", title: { tr: "Göz Kapağı Ameliyatı", en: "Blepharoplasty" }, excerpt: { tr: "Fazla deri ve yağ dokularının cerrahi olarak tamamen temizlenmesi.", en: "Complete surgical removal of excess skin and fat tissues." }, image: "/images/megagoz-goz-kapagi-tedavisi.jpg" },
      { slug: "goz-eti-pterjium", title: { tr: "Göz Eti (Pterjium)", en: "Pterygium" }, excerpt: { tr: "Güneşin ve tozun sebep olduğu korneaya yürüyen dokunun tedavisi.", en: "Treatment of corneal encroaching tissue caused by sun and dust." }, image: "/images/megagoz-kornea-tedavisi.jpg" },
  ...
  },
  {
    ...
    items: [
      ...
      { slug: "cocuklarda-ve-bebeklerde-goz-tembelligi", title: { tr: "Çocuklarda Ve Bebeklerde Göz Tembelliği", en: "Amblyopia (Lazy Eye) in Children" }, excerpt: { tr: "Kapama egzersizleriyle çocukluk çağında çözülmesi gereken gelişim hatası.", en: "Developmental error needing resolution through patching exercises." }, image: "/images/megagoz-cocuk-goz-tedavisi2.webp" },
      { slug: "cocuklarda-ve-bebeklerde-goz-kurulugu", title: { tr: "Çocuklarda Ve Bebeklerde Göz Kuruluğu", en: "Dry Eye in Children and Babies" }, excerpt: { tr: "Ekran kullanımı ve dijital yorgunluğun çocuklardaki sinsi belirtileri.", en: "Hidden symptoms of dry eye caused by screen usage and digital fatigue in children." }, image: "/images/megagoz-cocuk-goz-tedavisi.webp" }
    ]
  }
];
